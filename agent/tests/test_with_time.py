...
def test_model(model_name):
    ...
    results = []
    total_test_time = 0  # Общее время тестирования
    ...
    for i, test in enumerate(test_prompts):
        ...
        try:
            ...
            request_time = end_time - start_time  # Время выполнения запроса
            ...
            results.append({
                ...
                "correct": is_correct,
                "time": round(request_time, 2)  # Время с округлением до 2 знаков
            })
